											...
											<div class="service-content">
												...
												<div class="user-info">
													...
													<div class="service-action">
														<div class="row">
															<div class="col"><a href="javascript:void(0)" class="si-delete-inactive-service text-danger" data-id="<?php echo $srows['id']; ?>"><i class="fa fa-trash-alt"></i> Delete</a></div>
															<div class="col text-right"><a href="javascript:void(0)" class="si-delete-active-service text-success" data-id="<?php echo $srows['id']; ?>"><i class="fa fa-info-circle"></i> Active</a></div>
