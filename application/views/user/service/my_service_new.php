                                ...
                                <div class="service-widget">
                                    <div class="service-img">
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="cate-list">
                                                <a class="bg-yellow" href="<?php echo base_url() . 'search/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($srows['category_name'])); ?>"><?php echo $srows['category_name']; ?></a>
                                            </div>
                                        </div>
                                    </div>
...
$cat = str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($srows['service_title']));
 ...
 echo base_url() . 'service-preview/' . $cat . '?sid=' . md5($srows['id']); ?>"><?php echo $srows['service_title']; ?></a>
                                        ...
                                        <div class="rating">
                                            ...
                                            <span class="d-inline-block average-rating">(<?php echo $avg_rating ?>)
<?php $aaaaass="return confirm('Are you sure?')";
$con_delelete='onclick="'.$aaaaass.'"';

echo '<a href="'.base_url().'service-details-delete-del/'.$srows['id'].'" class="btn btn-sm bg-danger-light" '.$con_delelete.'>
<i class="fa fa-trash ml-4 btn-sm bg-danger-light"></i> Delete
</a>'; ?>
                                            </span>
                                        </div>
                                        <div class="user-info">
                                            <div class="row">
                                                ...
                                                <span class="col ser-location"><span><?php echo $srows['service_location']; ?></span> <i class="fa fa-map-marker-alt ml-1"></i></span>
                                            </div>
                                            <div class="service-action">
                                                <div class="row">
                                                    <div class="col"><a href="<?php echo base_url() ?>user/service/edit_service/<?php echo $srows['id'] ?>" class="text-success"><i class="fa fa-edit"></i> Edit</a></div>
                                                    <?php if ($service_availability == 0) { ?>

                                                        <div class="col text-right"><a href="javascript:void(0);" class="si-delete-service text-danger" data-id="<?php echo $srows['id']; ?>"><i class="fa fa-info-circle"></i> Inactive</a></div>
                                                    <?php } else { ?>
                                                        <div class="col text-right"><a href="javascript:void(0);" class="text-danger" data-toggle="modal" data-target="#deleteNotConfirmModal"><i class="fa fa-trash-alt"></i> Inactive</a></div>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>                                          
