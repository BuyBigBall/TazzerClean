							...
							<div class="service-content">
								...
								<div class="user-info">
									...
									<div class="service-action">
										<div class="row">
											<div class="col"><a href="<?php echo base_url()?>user/service/edit_service/<?php echo $srows['id']?>"><i class="fa fa-edit"></i> Edit</a></div>
											<div class="col text-right"><a href="javascript:void(0)" class="si-delete-service" data-id="<?php echo $srows['id']; ?>"><i class="fa fa-trash-alt"></i> Delete</a></div>
										</div>
									</div>
								</div>											
							</div>
