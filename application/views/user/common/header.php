...
<html>
    ...
    <head>
        ...
        <?php if (!empty($Orgcolor) && $Orgcolor == 1) { ?>
            <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style_org_old_tazzer.css?v1.05">
        ...
        <?php } else if (!empty($Defcolor) && $Defcolor == 1) { ?>
            <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style.css?v1.03">
        <?php } ?>
