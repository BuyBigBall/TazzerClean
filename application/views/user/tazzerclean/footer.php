...
<?php if($module=='home' || $module=='service_categories') { ?>
...
<?php if($this->uri->segment(1)=="user-chat"){ ?>
	<script src="<?php echo $base_url; ?>assets/js/user_chats.js?v1.04"></script>
<?php }?>
						...
						<div class="account-content">
							<div class="account-box">
								<div class="login-right">
									<div class="login-header">
										<h3>Login</h3>
										<p class="text-muted">Access to our <?=$this->website_name?></p>
									</div>
									<div class="form-group">
										<label>Email ID</label>
										<div class="row">
