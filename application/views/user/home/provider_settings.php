					...
					<div class="widget">
						...
						<div class="row">
							...
							<div class="form-group col-xl-4">
								...
								<div class="form-group col-xl-4">
								<label class="mr-sm-2">corency<?php echo (!empty($user_language[$user_selected]['lg_Sub_Category'])) ? $user_language[$user_selected]['lg_Sub_Category'] : $default_language['en']['lg_Sub_Category']; ?></label>
