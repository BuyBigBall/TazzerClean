		 ...
		 <div class="row">
			 <div class="col">
				 <div class="breadcrumb-title">
					<h2> Add to wallet - <?php echo $currency['user_currency_code'].$amount; ?> </h2>
				</div>
			</div>
							 ...
							 <input type="hidden" name=" <?php echo $this->security->get_csrf_token_name(); ?>" value=" <?php echo $this->security->get_csrf_hash(); ?>" />
								<div class="row">
									<div class="form-group hide_div_new col-md-12">
										...
										<input name="data[card_number]" placeholder="Enter card number" class="form-control numeric" data-stripe="number" size="20" maxlength="19" type="text" id="card_number">										<span class="card_number_error inline_errors"></span>
									</div>
									...
									<div class="form-group hide_div_new col-md-4">
											<input name="data[expiration_month]" placeholder="MM" class="form-control numeric" data-stripe="exp_month" size="2" maxlength="2" type="text" id="expiration_month">											<span class="expiration_month_error inline_errors"></span>
											
									</div>
									
									
									<div class="form-group hide_div_new col-md-4">
											<input name="data[expiration_year]" placeholder="YY" class="form-control numeric" data-stripe="exp_year" size="2" maxlength="2" type="text" id="expiration_year">											<span class="expiration_year_error inline_errors"></span>
									</div>
									
										<div class="form-group col-md-4 hide_div_new">
											<input name="data[card_cvs]" placeholder="CVV" class="form-control numeric" data-stripe="CVC" size="4" maxlength="4" type="text" id="card_cvs">											<span class="card_cvs_error inline_errors"></span>
										</div>
...
$.ajax({
  method: "POST",
  url: "../user/dashboard/user_stipe_payment_process",
	data:{ 
  ...
  .done(function( msg ) {
	 if(msg.trim()=='success')
	{
		window.location="<?php echo base_url(); ?>user-wallet/";
	}
	else
	{
		alert(msg.trim());
