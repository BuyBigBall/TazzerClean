                                ...
                                <div class="booking-list">
                                    ...
                                    <div class="booking-action">
                                        ...
                                        <?php if ($bookings['status'] == 2) {
                                            ...
                                            <a href="javascript:void(1);" class="btn btn-sm bg-success-light update_pro_booking_status"  data-id="<?= $bookings['id']; ?>" data-status="3" data-rowid="<?= $pending; ?>" data-review="2">
                                        ...
                                        <?php } elseif ($bookings['status'] == 1) {
                                            ...
                                            ?>
                                            <a href="javascript:void(1);" class="btn btn-sm bg-success-light update_pro_booking_status"  data-id="<?= $bookings['id']; ?>" data-status="2" data-rowid="<?= $pending; ?>" data-review="2" >
