 ...
 <!-- <div class="form-row"> -->
        ...
        <div class="row">
          ...
          <div class="col-xl-6">
           ...
           <div class="col-xl-4">
                    <select required="true" class="form-control border-dark" id="colorselector">
            ...
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-26" >
              <label class="custom-control-label" for="checkbox-26">My own car</label>
            </div>
          </div>
          <div class="col-xl-6">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-27" >
              <label class="custom-control-label" for="checkbox-27">Public transportation</label>
            </div>
          </div>
            <div class="col-xl-6">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-26" >
              <label class="custom-control-label" for="checkbox-26">Borrowing a car</label>
            </div>
          </div>
          <div class="col-xl-6">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-27" >
              <label class="custom-control-label" for="checkbox-27">Other / not sure yet</label>
            </div>
          </div>
        </div>
        </div>
