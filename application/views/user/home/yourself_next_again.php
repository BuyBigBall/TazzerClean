        ...
        <div class="tab-content pt-0">
          <div class="tab-pane show active" id="user_profile_settings" >
            <div class="widget">
              ...
              <form id="update_user" action="<?php echo base_url()?>fourth_step" method="POST" enctype="multipart/form-data"novalidate >
...
<h3 class="col-xl-12 mt-5 mb-2"><strong>Background checks:  </strong></h3>
 ...
 <div class="row">
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-26" >
              <label class="custom-control-label" for="checkbox-26">Yes</label>
            </div>
          </div>
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio1" class="custom-control-input" id="checkbox-27" >
 ...
 <div class="row">
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio2" class="custom-control-input" id="checkbox-28" >
              <label class="custom-control-label" for="checkbox-28">Yes</label>
            </div>
          </div>
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio2" class="custom-control-input" id="checkbox-29" >
 ...
 <div class="row">
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio3" class="custom-control-input" id="checkbox-30" >
              <label class="custom-control-label" for="checkbox-30">Yes</label>
            </div>
          </div>
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio3" class="custom-control-input" id="checkbox-31" >
 ...
 <div class="row">
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio4" class="custom-control-input" id="checkbox-32" >
              <label class="custom-control-label" for="checkbox-32">Yes</label>
            </div>
          </div>
          <div class="col-xl-3">
            <div class="custom-control custom-checkbox checkbox-xl">
              <input type="radio" name="radio4" class="custom-control-input" id="checkbox-33" >
 ...
 <div class="row">
          ...
          <div class="col-xl-7 mt-3 colors_bb3 desc1" style="display:none" id="Cars11"> 
                  <!--   <h5 class="form-title font-weight-bold"> Please add name:</h5> -->
                    <input type="text" name="name_" value="" placeholder="Please Enter" class="form-control border-dark">
