...
<div class="d-flex justify-content-center align-items-center container">
    <div class="card py-5 px-3">
    	<form method="POST" action="<?php echo base_url()?>verifyotp" enctype='multipart/form-data'>
...
//echo $sess_mobil=$this->session->userdata('mobile_otp',$mobile_otp);
   // echo    '==='.$sess_email=$this->session->userdata('email_otp',$email_otp);
        ?>
      <input type="hidden" value='<?php echo $sess_mobil=$this->session->userdata('mobile_otp',$mobile_otp); ?>' >  
            </b>
        <br class="mt-4">
