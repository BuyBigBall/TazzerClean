			...
			<div class="col-xl-8 offset-xl-2">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="mt-4">
								<a href="javascript:;" class="on-default remove-row btn btn-primary mr-2 reply_contact" id="Onremove_<?=$contact_details['id']?>" data-uname="<?=$contact_details['name']?>" data-mail="<?=$contact_details['email']?>" data-id="<?=$contact_details['id']?>"><i class="fa fa-envelope"></i> Reply</a>
                            </div>
