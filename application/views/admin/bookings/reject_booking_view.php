                                ...
                                <tbody>
									...
									echo '<tr>
										...
										if($rows['admin_change_status']==1){
											...
											<a href="#" class="btn btn-sm bg-warning-light mr-2"><i class="fa fa-edit mr-1"></i> Changed</a>
										</td>'; 
										}else{
                                        echo'<td class="text-right">
											<a href="'.base_url().'reject-payment/'.$rows['id'].'" class="btn btn-sm bg-success-light mr-2"><i class="fa fa-edit mr-1"></i> Edit</a>
                                        </td>';
										}
									echo'</tr>';
									} 
