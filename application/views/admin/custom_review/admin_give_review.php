	...
	<div class="content container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form id="update_user" action="<?php echo base_url().'review_submit/'.$id?>" method="POST" enctype="multipart/form-data">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                		
              <div class="col-xl-6 mt-2">
                <h5 class="form-title font-weight-bold">Display Name</h5>
                <input type="text" name="revierwer_name" value="" placeholder="Enter Reviewer Name" class="form-control border-dark" required>
              </div>	
              <div class="col-xl-6 mt-2">
                ...
                <textarea name="review" placeholder="Enter Review" class="form-control border-dark" required>Enter Review</textarea>
              </div> 
              <div class="col-xl-3 mt-2">
                <h5 class="form-title font-weight-bold">Rating <small>(1 To 5)</small></h5>
                <input type="number" name="rating" placeholder="Enter Rating" class="form-control border-dark" min="1" max="5" required>
              </div>  

              <div class="col-xl-3 mt-2">
                <h5 class="form-title font-weight-bold">Date And Time</h5>
                <input type="datetime-local" name="date_time" placeholder="Enter Date And Time" class="form-control border-dark" required>
              </div> 
