    ...
    $result = $query->result_array();
        ...
        if (count($result) > 0) {
            ...
            foreach ($result as $r) {
                ...
                $data['service_amount'] = (!empty($ProviderCurrency) && $r['currency_code'] !='') ? get_gigs_currency($r['service_amount'],$r['currency_code'],$ProviderCurrency) : $r['service_amount'];
                ...
                $data['currency'] = (!empty($ProviderCurrency)) ? currency_conversion($ProviderCurrency) : currency_conversion(settings('currency'));
                $response[] = $data;
            }
