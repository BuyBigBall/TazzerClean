...
class Dashboard_model extends CI_Model {
	...
	public function __construct() {
		...
		private function p_get_datatables_query()
		{
			...
			$this->db->select('U.id,U.name,U.profile_img,U.mobileno,U.email,U.token,created_at as created_at,U.last_login,U.status,U.type,S.subscription_name,SD.subscriber_id');
