...
else
{
	...
	public function user_stipe_payment_process()
	{
		...
		(
			...
			"private_live_key" => "",
			"public_live_key"  => "",
			"private_test_key" => "sk_test_eNdOgNgDA7g82RVs2t5YjpJ7",
			"public_test_key"  => "pk_test_stUzFHkiYZqX6haMxT8sQ8VW"
		);
		...
		{			
			$error = $e->getMessage();
			$result = "There is some error in your request. Please try again.";
		} 
	...
	public function user_stipe_sub_payment_process()
	{
		$this->db->select('*');
